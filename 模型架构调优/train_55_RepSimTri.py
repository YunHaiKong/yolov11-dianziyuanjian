...
if __name__ == '__main__':
    ...
    pretrainedModel = 'runs/dianziyuanjian_55/train/weights/best.pt'
    
    cfgYAML = 'ultralytics/cfg/models/11/yolo11RepC3K2SimSPPF_TriPSA.yaml'
    ...
    # 训练模型，明确指定任务类型和保存路径
    model.train(
                data='ultralytics/cfg/datasets/dianziyuanjian_55.yaml', 
                epochs=100,
                task='detect',  # 明确指定检测任务
                project='runs/dianziyuanjian__55_RepC3K2SimSPPF_TriPSA',  # 自定义项目文件夹名称
                name='train',  # 自定义实验名称
